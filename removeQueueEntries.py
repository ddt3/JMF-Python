"""
Contains an example on how jmfmessasge module can be used to remove queue entries
"""
import argparse
...
parser.add_argument('--status', '-s', type=str, default=QueueIDState, help='The status of the jobs that need to be removed or listed.","To remove all QueueEntries use: \" \"  To remove multiple statuses use: \"Aborted Completed\" (default: '+QueueIDState+')')#pylint: disable=C0301
