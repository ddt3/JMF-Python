"""
Contains an example on how jmfmessasge module can be used to send jobs
"""

from jmfjdf.jmfmessages import CreateMimePackage, SendJob, SendMimeJob

# The jmfmessages library contains examples of how jmf can be used to send commands to PRISMAsync
# and obtain information from PRISMAsync. This file is an example of how the libraries can be used
# to send jobs to PRISMAsync

# Make sure to adapt these lines to your situation: provide PRISMAsync address and web-url to PDF file
